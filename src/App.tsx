  ...
  return <main>
    <section className="hero" id="home">
      ...
      <header className="site-header">
        ...
        <nav id="main-navigation" className={menuOpen ? 'open' : ''} aria-label="Main navigation"><a onClick={closeMenu} href="#home">Home</a><a onClick={closeMenu} href="#history">History</a><a onClick={closeMenu} href="#explore">Explore</a><a onClick={closeMenu} href="#gallery">Gallery</a><a onClick={closeMenu} href="#visit">Visit</a><a onClick={closeMenu} href="#guide">Guide</a><a onClick={closeMenu} href="#contact">Contact</a></nav>
      </header>
